...
const Icon = ({ name, size = 18, color = "currentColor", style, className }) => {
  ...
  switch (name) {
    ...
    case "api": return S(<><path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" /><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" /></>);
    case "robot": return S(<><rect x="3" y="11" width="18" height="10" rx="2" /><circle cx="12" cy="5" r="2" /><path d="M12 7v4" /><line x1="8" y1="16" x2="8" y2="16" strokeWidth="2" /><line x1="16" y1="16" x2="16" y2="16" strokeWidth="2" /><path d="M2 14h1" /><path d="M21 14h1" /></>);
    case "industries": return S(<><path d="M22 21H2M19 21V10l-4-3v4l-4-3v4L7 8v13" /></>);
    case "deployment": return S(<><path d="M16 16l-4-4-4 4" /><path d="M12 12v9" /><path d="M20.39 18.39A5 5 0 0018 9h-1.26A8 8 0 103 16.3" /></>);
    default: return null;
  }
};
